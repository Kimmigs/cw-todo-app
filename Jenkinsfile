pipeline {
    ...
    environment {
        PATH=(script:"echo $PATH:/usr/local/bin", returnStdout:true).trim()
    ...
    stages {
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'key_pair', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yml'
             }
        }
